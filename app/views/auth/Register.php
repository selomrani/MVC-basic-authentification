    ...
    <div class="flex min-h-screen">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative bg-indigo-900 text-white flex-col justify-center p-12 overflow-hidden">
            ...
            <div class="relative z-10 max-w-lg">
                <h2 class="text-4xl font-bold leading-tight mb-4">Start your journey with us.</h2>
                <p class="text-indigo-200 text-lg">Join thousands of developers building the future of the web. It takes less than a minute.</p>
            </div>
            
            <!-- Optional Copyright footer (kept for layout balance, can remove if needed) -->
            ...
            <div class="w-full max-w-md space-y-8">
                ...
                <div class="text-center lg:text-left">
                    ...
                    <p class="mt-2 text-sm text-gray-600">
                        ...
                        <a href="/login" class="font-medium text-indigo-600 hover:text-indigo-500 transition-colors">Log in here</a>
                    </p>
                </div>
